...
- Because the plugin persists local runtime mode in `.opencode-autoresearch-state.json`, that file should be gitignored and must not be committed from this dotfiles repo.
