...
# Initialization that produces output (e.g. autocompleted welcome msgs, ssh-agent
# spinup) breaks instant prompt. Move such code to ~/.zprofile or below this block.
